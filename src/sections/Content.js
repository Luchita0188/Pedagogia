...
import {
  Cover, Page1, Page2, Page3, Page4, Page5, Page6, Page7, Page8, Page9, Page10, Page11
} from './pages/Pages';
...
class Content extends Component {
  showContent = () => {
    ...
    switch (actualIndex) {
      ...
      case 9: return( <Page9 dataPage = { data.page9 } startQuiz = { clickNavigation } /> );

      case 10: return( <Page10 dataPage = { data.page10 } endActivities = { endActivities[10] } checkEndActivity = { checkEndActivity } setScore = { setScore } endQuiz = { clickNavigation} />);

      // END --------------------------------------------------------------------------------
      case 11: return( <Page11 dataPage = { data.page11 } calificacion = { calificacion } /> );
