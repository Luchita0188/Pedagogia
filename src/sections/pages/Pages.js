    ...
    return (
      <div className={"pageContent"}>
        <div className="c-10 animated fadeIn d-Flex d-C j-C pT-4 mL-40">
          <div className="headerTitle tCenter mL-2 mT-025 mR-2 mB-2 F1-5 pT-4 pB-1">
            {dataPage.title ? (
              <h2
                className="mB-2 fw-7 F2"
                dangerouslySetInnerHTML={{ __html: dataPage.title }}
              ></h2>
            ) : null}
            {dataPage.text ? (
...
class Page3 extends Component {
  ...
  render() {
    ...
    return (
      <div className={"pageContent"}>
        <div className="c-10 animated fadeIn">
          <div className="c-10 animated fadeIn d-Flex aI-C j-S pT-5 mL-1">
            <div className="mL-5 c-35 mT-2">
              {dataPage.title ? (
                <h2
                  className="mB-1 F1-5"
                  dangerouslySetInnerHTML={{ __html: dataPage.title }}
            ...
            <div className="c-6 d-Flex j-C aI-S mT-3 mL-3 mB-1" style={style}>
    ...
    return (
      <div className={"pageContent"}>
        ...
        <div className="c-10 animated fadeIn d-Flex aI-C j-S pT-7 mT-1">
          <div className="mL-2 pB-3 c-30 mT-1"></div>
...
class Page5 extends Component {
  ...
  render() {
    ...
    return (
      <div className={"pageContent"}>
        <div className="headerTitle d-Flex d-Rr j-E aI-C mB-1 mL-3">
          <div className="c-10 animated fadeIn">
            <div className="mL-3 c-7 mR-1 mB-2">
              {dataPage.title ? (
                <h2
                  className="mB-1 pT-1 mT-3 mR-2"
                  dangerouslySetInnerHTML={{ __html: dataPage.title }}
                ></h2>
              ) : null}
              {dataPage.text ? (
                <p
                  className="mB-1 pT-1 fw-4"
                  dangerouslySetInnerHTML={{ __html: dataPage.text }}
                ></p>
              ) : null}
            </div>
        ...
        {dataPage.nota ? (
          <p
            className=" dF-R-bc j-E mL-7 mR-7 pR-7 mB-7 pL-7 pT-1 mT-1 fw-3"
            dangerouslySetInnerHTML={{ __html: dataPage.nota }}
          ></p>
        ) : null}
      </div>
    );
...
class Page6 extends Component {
  ...
  render() {
    ...
    return (
      <div className={"pageContent"}>
        <div className="headerTitle d-Flex d-Rr j-E aI-C mB-1 mL-3 mT-2">
          <h2
        ...
        <div className="c-10 animated fadeIn">
          <div className="mL-3 c-35 mT-025 mR-2 mB-2">
            {dataPage.title ? (
              <h2
                className="mB-05"
                dangerouslySetInnerHTML={{ __html: dataPage.title }}
...
class Page8 extends Component {
  ...
  render() {
    ...
    return (
      <div className={"pageContent"}>
        <div className ="c-10 d-Flex d-C j-C aI-S animated fadeIn">
          <div className ="mL-6 c-7 mT-6 mR-3 ">
            {dataPage.title ? (
              <h2
                className ="textHeader F2 mB-1"
                dangerouslySetInnerHTML={{ __html: dataPage.title }}
          ...
          <div className = 'mL-2 d-Flex d-R j-S aI-S wNw c-10 fw-4'>
          <div className = 'd-Flex j-S aI-C c-35 mR-1 mL-4 mB-1 mT-2'>
              ...
              <p className = 'mR-1 fw-5 F1 titulo1' dangerouslySetInnerHTML = {{ __html: dataPage.link2.text  }}></p>
            </div>

            <div className = 'd-Flex j-S aI-C c-4 mB-1 mR-1 mT-2'>
              <a className = 'mR-1 fw-2' href = { dataPage.link.route } target = '_blank' rel='noopener noreferrer'><img alt = 'Imagen' className = '' src = { dataPage.resources.img2 }/></a>
              <p className = 'mR-1 fw-5 F1 titulo1' dangerouslySetInnerHTML = {{ __html: dataPage.link.text  }}></p>
            </div>

            <div className = 'd-Flex j-S aI-C c-4 mR-1 mL-4 mB-1 mT-2'>
              <a className = 'mR-1 fw-2' href = { dataPage.link3.route } target = '_blank' rel='noopener noreferrer'><img alt = 'Imagen' className = '' src = { dataPage.resources.img2 }/></a>
              <p className = 'mR-1 fw-5 F1 titulo1' dangerouslySetInnerHTML = {{ __html: dataPage.link3.text  }}></p>
            </div>
          </div>
          </div>
  ...
  render() {
    ...
    return (
      <div className={"pageContent"} style={style}>
        <div className="headerTitle d-Flex pL-2 j-C aI-C mT-6"></div>
        ...
        <div className="c-5 mL-1 mT-2 mB-2">
          {dataPage.title ? (
            <h3
              className="d-Flex mL-3 mB-2 pL-2 j-C F2 fw-7"
              dangerouslySetInnerHTML={{ __html: dataPage.title }}
            ></h3>
          ) : null}
          ...
          {dataPage.text1 ? (
            <p
              className="d-Flex mL-3 mB-2 pL-2 j-C F2 fw-7 color-17"
              dangerouslySetInnerHTML={{ __html: dataPage.text1 }}
            ></p>
          ) : null}

          <button
            className="buttonQuiz1 pT-1 pB-1 pL-1 pR-1 fw-3 mL-7 j-S aI-C"
            id="btnQuiz"
      ...
      <div className={"pageContent"}>
        <div className="c-10 animated fadeIn">
          <div className="mL-2 mT-3">
            {dataPage.title ? (
              <h3
                className="F2 mB-2 mL-3"
                dangerouslySetInnerHTML={{ __html: dataPage.title }}
              ></h3>
            ) : null}
            {dataPage.text ? (
              <p
                className=" mL-3 mB-2 mT-2 fw-4 mR-05"
                dangerouslySetInnerHTML={{ __html: dataPage.text }}
              ></p>
            ) : null}
          </div>
